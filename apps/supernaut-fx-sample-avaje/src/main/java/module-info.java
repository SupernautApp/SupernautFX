...
module app.supernaut.fx.sample.avaje {
    ...
    opens app.supernaut.fx.sample.avaje to javafx.graphics, java.base;
    exports app.supernaut.fx.sample.avaje;

    provides InjectExtension with app.supernaut.fx.sample.avaje.AvajeInjectModule;
