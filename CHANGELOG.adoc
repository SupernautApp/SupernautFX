...
* Upgrade to Micronaut 2.1.1
* Change `api` dependency in `app.supernaut.fx.micronaut` from `micronaut-inject-java` to `micronaut-inject` (reduces transitive dependencies)
